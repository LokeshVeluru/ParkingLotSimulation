    ...
    class AppServices : IAppServices
    {
        ...
        public void ParkVehicle()
        {
            ...
            if(slot != null)
            {
                ...
                Vehicle vehicle = GetVehicleInstance(slot.Type, vehicleNumber);
        ...
        public Slot ChooseSlot(VehicleType type)
        {
            ...
            try
            {
                ...
                else
                {
                    ...
                    slot = parkingLot.slots.Single(s => s.Id == slotNumber);
                }
            }
            catch(Exception e)
            {
        ...
        public Vehicle GetVehicleInstance(VehicleType type, String vehicleNo)
        {
            Vehicle vehicle = null;
            switch (type)
            {
                case VehicleType.TWO_WHEELER:
                    vehicle = new TwoWheeler(vehicleNo);
                    break;
                case VehicleType.FOUR_WHEELER:
                    vehicle = new FourWheeler(vehicleNo);
                    break;
                case VehicleType.HEAVY_VEHICLE:
                    vehicle = new HeavyVehicle(vehicleNo);
                    break;
            }
            return vehicle;
        }
        ...
        public void UnparkVehicle()
        {
            try
            {
                ...
                if (ticket != null && IsSlotFilled(ticket.SlotNumber))
                {
        ...
        public bool IsSlotFilled(int slotNumber)
        {
            Slot slot = parkingLot.slots.Single(s => s.Id == slotNumber);
